...
class Solution(object):
    def addTwoNumbers(self, l1, l2):
        ...
        """ 
            ...
            - Turns out we dont need to extract the nums from the lists at all.
              Since they're in reverse we can just use carry addition to
              add a corresponding digit from each list and put the result into
              a new list
        """
        # track current ptr in each input list
        cur1, cur2 = l1, l2
        # get a starter dummy node and a cur ptr
